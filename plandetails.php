                    ...
                    <div class="col-xs-10 col-xs-offset-1 col-md-5 col-md-offset-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <form method="POST" action="plandetail_submit.php?budget=<?php echo $ib ?>&people=<?php echo $no_of_people ?>" autocomplete="off">
                                    <div class="form-group bw">
                                        <div class="col-xs-12">
                                            <lable for="title_trip"><b>Title</b></lable>
                                            <input type="text" class="form-control" placeholder="Enter Title (Ex:- Trip to Goa)" name="title_trip" required="true" autocomplete="off">
                                        </div>
                                    </div>

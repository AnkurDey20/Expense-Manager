                                    ...
                                    <div class="panel panel-success">
                                        ...
                                        <div class="panel-footer">
                                            ...
                                            if ($comp == "No file choosen") {
                                                ...
                                                ?>
                                                <a href="<?php echo $comp ?>" target="_blank"> Show Bill</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
                            ...
                            <div class="panel-body">
                                <form method="POST" enctype="multipart/form-data" action="add_expense.php?iplan=<?php echo $idpass ?>&id=<?php echo $ids ?>">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Expense Name" name="title_expense" required="true" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                    <lable for="by-whom"><b>By Whom</b></lable>

                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $spent = array();
                                    $names = strtok($name1, ",");
                                    // Searching for expenses made by all persons
                                    while ($names) 
                                    {
                                    ...
                                    <?php
                                        ...
                                        // Adding expense of each person and storing it in array by their names
                                    ...
                                    <br>
                                    <?php
                                        // Formulating and showing the remaining amount for each person
                                        $names = strtok($name1, ',');
                                        while ($names) {
                                            ?>
                                            <b><?php echo $names; ?></b>
